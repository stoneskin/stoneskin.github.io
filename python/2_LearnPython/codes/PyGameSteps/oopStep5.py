...
class Enemy:
    ...
    def __init__(self,x,y) -> None:        
        ...
        self.img=pygame.transform.scale(enemyImg, (75, 75)).convert_alpha()
...
class AirForceGame:
    ...
    def startGame(self):
        ...
        keep_going = True
        player=Player(100,100,self.width,self.height)
        ...
        while keep_going:
            ...
            for event in pygame.event.get():
                ...
                if event.type==pygame.QUIT:
                    keep_going = False
                player.onKeyEvent(event) #update player for event 
